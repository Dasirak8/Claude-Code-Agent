  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        <SectionHeader
          title="Predictions"
          subtitle="Illustrative confidence scores for MVP visualization, not real predictive modeling."
        />
        <DataStatusBadge />
      </div>
      <DataDisclaimer message="Confidence scores are placeholder values for demo purposes and are not generated by a real prediction model." />
